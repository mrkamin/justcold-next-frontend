...
const OurServices = () => {
  ...
  return (
    <div id="services" className="ourservices-container" data-aos="fade-up">
      <div className="relative ourservices-wrapper">
        <div className="flex relative flex-col pt-20 items-center bg-blue-200 flex-col gap-10">
              ...
              <div className="flex flex-col gap-2 place-items-center text-[#1f1f38]">
                <div className="place-items-center">
                  ...
                  <p className="section-description">
                    See how New Cold Rooms are built with advanced techniques that make us different.
                  </p>
              </div>
            </div>
            <OurServiceVideoSec />
